...
BEGIN
  ALTER DATABASE movie_tracker SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
...
INSERT INTO genres VALUES('Short');
...
INSERT INTO verify VALUES('genres', (SELECT COUNT(*) FROM genres), 23);
